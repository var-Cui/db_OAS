...
public class RegisterVo {
	...
	private int register_staffNum;//请假登记者编号
	private String register_name;//请假登记者姓名
	private String register_branch;//请假者登记部门
	private String register_type;//请假登记类型
	private String register_reason;//请假原因
	private Date register_startTime;//请假开始时间
	private Date register_endTime;//请假到期时间
	private String register_assentor;//请假审核人
	private String register_result;//审核结果（待审核  未通过 已通过）
	private String register_note;//审核结果的原因
