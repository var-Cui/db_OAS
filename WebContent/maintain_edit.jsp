...
<form name="form1" method="post" action="maintainServlet?action=update" >
<table width="518" border="0" cellspacing="0">
  <tr>
    ...
    <td width="484" background="image/tablehdbg1.gif"><span class="STYLE7">系统设置&gt;</span>菜单修改&gt;&gt;&gt;</td>
  </tr>
</table>
...
<table width="517" height="82%" border="0" cellpadding="0" cellspacing="1" bgcolor="#0077B2">
        ...
        <tr>
          ...
          <td height="25" align="left" valign="middle" bgcolor="#FFFFFF">
            &nbsp;<input name="maintain_menu" type="text"  value="${result.maintain_menu }"  style="border:0px;"></td>
            <input name="maintain_id" type="hidden" id="id" value="${result.maintain_id}"><!-- 隐藏域带个id -->
        </tr>
        <tr>
          <td height="25" align="center" valign="middle" bgcolor="#FFFFFF">url</td>
          <td height="25" align="left" valign="middle" bgcolor="#FFFFFF">
            &nbsp;<input name="maintain_url" type="text"  value="${result.maintain_url }"  style="border:0px;"></td>
        </tr>
        <tr>
