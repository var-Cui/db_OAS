...
<table width="518" border="0" cellspacing="0">
  <tr>
    ...
    <td width="484" background="image/tablehdbg1.gif"><span class="STYLE7">出差登记</span></td>
  </tr>
</table>

<table width="517" height="82%" border="0" cellpadding="0" cellspacing="1" bgcolor="#0077B2">
        <tr>
          <td height="22" colspan="2" background="../image/beijing.gif" bgcolor="#FFFFFF"><span class="STYLE6">&nbsp;&nbsp;出差记录：</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="25" align="left" valign="middle" bgcolor="#FFFFFF">&nbsp;
          <input name="register_type" type="text" readonly="readonly" value="<%="出差"%>"  style="border:0px;"></td>
		 <tr>
