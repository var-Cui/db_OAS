...
function initializeFolder(level, lastNode, leftSide)
{
	...
	if (level>0)
		...
		{
			this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='" + ImgDir + "mnode.gif' width=18 height=20 align=left border=0 vspace=0 hspace=0 border=0>");
...
function drawFolder(leftSide)
{
	...
	doc.write("src='" + ImgDir + this.iconSrc+"'  width=18 height=16 align=left border=0 vspace=0 hspace=0 border=0>");
