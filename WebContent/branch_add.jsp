...
<form name="form1" method="post" action="branchServlet?action=add" >
<table width="518" border="0" cellspacing="0">
  <tr>
    ...
    <td width="484" background="image/tablehdbg1.gif"><span class="STYLE7">部门管理&gt;</span>部门添加&gt;&gt;&gt;</td>
  </tr>
</table>
...
<table width="517" height="82%" border="0" cellpadding="0" cellspacing="1" bgcolor="#0077B2">
        ...
        <tr>
          ...
          <td height="25" align="left" valign="middle" bgcolor="#FFFFFF">
            &nbsp;<input name="branch_name" type="text"  value=""  style="border:0px;"></td>
        </tr>
        <tr>
          <td height="25" align="center" valign="middle" bgcolor="#FFFFFF">部长</td>
          <td height="25" align="left" valign="middle" bgcolor="#FFFFFF">
            &nbsp;<!-- <input name="branch_minister" type="text"  value=""  style="border:0px;"> -->
            <select name="branch_minister">
		  <c:forEach items="${list}" var="a">
		     <option value=${a.staff_name }>${a.staff_name}</option>
		 </c:forEach>
		  </select>
            </td>
        </tr>
        <tr>
          ...
          <td height="25" align="left" valign="middle" bgcolor="#FFFFFF">
            &nbsp;<input name="branch_summarize" type="text"  value=""  style="border:0px;height : 57px; width : 351px;"></td>
        </tr>
        <tr>
          <td height="25" align="center" valign="middle" bgcolor="#FFFFFF">创建时间</td>
          <td height="25" align="left" valign="middle" bgcolor="#FFFFFF">
            &nbsp;<input id="branch_time" name="branch_time" type="text"  value=""  style="border:0px;"></td>
        </tr>  
        <tr>
