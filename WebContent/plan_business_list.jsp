...
<table width="978"  border="0" cellspacing="0" cellpadding="0" align="left">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">当前位置：计划制定 &gt; 企业计划管理 &gt;&gt;</td>
      </tr>
      <tr>
        <td align="center" valign="top">
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="15%" align="center"><a href="planServlet?action=planBusinesslist" style="COLOR: #ff0000;">查看全部计划</a> </td>
    <td width="10%"><a href="planServlet?action=planBusinessVerifyQuery" style="COLOR: #ff0000;">待审核</a> </td>
	<td width="10%"><a href="planServlet?action=planBusinessPassQuery" style="COLOR: #ff0000;">已通过</a></td>
	<td width="10%"><a href="planServlet?action=planBusinessRefuseQuery" style="COLOR: #ff0000;">未通过</a></td>
	<td width="20%"></td>
	<c:if test="${sessionScope.staffVo.staff_position eq a or sessionScope.staffVo.staff_position eq b}">
	<td width="20%" align="center"><a href="plan_business_add.jsp">添加企业计划</a></td>
	</c:if>  
  </tr>
</table>  
  ...
  <c:forEach items="${planList}" var="v">
    ...
    <td align="center"><a href="planServlet?action=planDel&plan_id=${v.plan_id}&check=bus">
    <c:if test="${sessionScope.staffVo.staff_position eq a or sessionScope.staffVo.staff_position eq b}"> 
    	<c:if test="${sessionScope.staffVo.staff_num eq v.plan_promulgatorNum }">
    	删除
    	</c:if>
    </c:if>
    </a></td> 
